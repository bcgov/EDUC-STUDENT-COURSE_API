        ...
        try {
            ...
            studentCourses.forEach(sC -> {
                if (StringUtils.isNotBlank(sC.getRelatedCourse()) || StringUtils.isNotBlank(sC.getRelatedLevel())
                        || StringUtils.isNotBlank(sC.getAlternateCourseName())
                        || StringUtils.isNotBlank(sC.getBestSchoolPercent() != null ? sC.getBestSchoolPercent().toString() : null)
                        || StringUtils.isNotBlank(sC.getBestExamPercent() != null ? sC.getBestExamPercent().toString() : null)
                        || StringUtils.isNotBlank(sC.getMetLitNumRequirement())) {
                ...
                if (sC.getCourseLevel() != null) {
                    if (sC.getCourseLevel().trim().equalsIgnoreCase("")) {
                        Course course = webClient.get()
                                .uri(String.format(getCourseByCrseCodeOnlyURL, sC.getCourseCode()))
                        ...
                        Course course = webClient.get()
                                .uri(String.format(getCourseByCrseCodeURL, sC.getCourseCode(), sC.getCourseLevel()))
                                .headers(h -> h.setBearerAuth(accessToken))
                                .retrieve()
                                .bodyToMono(Course.class)
                                .block();
                ...
                if (StringUtils.isNotBlank(sC.getRelatedCourse()) || StringUtils.isNotBlank(sC.getRelatedLevel())) {
                    if (sC.getRelatedLevel() != null) {
                        if (sC.getRelatedLevel().trim().equalsIgnoreCase("")) {
                            Course course = webClient.get()
                                    .uri(String.format(getCourseByCrseCodeOnlyURL, sC.getRelatedCourse()))
                                    .headers(h -> h.setBearerAuth(accessToken))
                                    .retrieve()
                                    .bodyToMono(Course.class)
                                    .block();
                            ...
                            Course course = webClient.get()
                                    .uri(String.format(getCourseByCrseCodeURL, sC.getRelatedCourse(), sC.getRelatedLevel()))
                                    .headers(h -> h.setBearerAuth(accessToken))
                                    .retrieve()
                                    .bodyToMono(Course.class)
                                    .block();
